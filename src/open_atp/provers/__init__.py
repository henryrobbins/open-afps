...
#: Prover *type* name -> the :class:`AutomatedProver` subclass. The factory in
#: :mod:`open_atp.config` dispatches a ``prover`` spec's ``type`` through this; the
#: high-level standard catalog (:data:`~open_atp.config.STANDARD_PROVERS`) is layered
#: on top of it.
PROVERS: dict[str, type[AutomatedProver]] = {
    "agent": AgentProver,
    "numina": NuminaProver,
