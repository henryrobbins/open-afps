...
```bash
uv run --no-project .claude/skills/cli/axle.py sorry2lemma CONTENT --environment ENV [OPTIONS]
```
...
```bash
uv run --no-project .claude/skills/cli/axle.py sorry2lemma proof.lean --environment lean-4.28.0
uv run --no-project .claude/skills/cli/axle.py sorry2lemma proof.lean --environment lean-4.28.0 --reconstruct-callsite
uv run --no-project .claude/skills/cli/axle.py sorry2lemma proof.lean --environment lean-4.28.0 --verbosity 1
```
